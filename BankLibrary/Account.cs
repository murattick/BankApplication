namespace BankLibrary
{
    public abstract class Account : IAccount
    {
        ...
        //события создания, добавления, удаления счетов, так же расчёт процентов
        // вызов отдельных событий. Для каждого события определяется свой виртуальный метод
        //виртуальный метод служит для того, чтобы его можно было переопределить с помощью override
